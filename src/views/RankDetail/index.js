...
function RankDetail(props) {
    ...
    return (<>
        <div>
            <MusicList rank={true} title={playlist.title} bgImage={playlist.picUrl} list={state.list}/>
        </div>
    </>)
}

export default connect(state => state, {dispatch})(RankDetail);